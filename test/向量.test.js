...
describe('測試【加】', function () {
  ...
  test('[1,2,3]加上[2,3]，應拋出例外參數錯誤', function () {
    expect(() => new 向量([1, 2, 3]).加(new 向量([2, 3]))).toThrow(參數錯誤)
  })

  test('[1,2,3]加上"a"，應拋出例外型別錯誤', function () {
    expect(() => new 向量([1, 2, 3]).加('a')).toThrow(型別錯誤)
  })
})

describe('測試【乘】', function () {
  test('傳入的參數不是數值，應拋出型別錯誤例外', function () {
...
describe('測試【遍歷每個元素但是排除】', function () {
  test('排除的項目不是位元陣列，應拋出型別錯誤例外', function () {
...
describe('測試【相等於】', function () {
  test('對象不是向量，應拋出型別錯誤例外', function () {
    const 測試向量 = new 向量([1, 2, 3, 4])
...
describe('測試【第一個大於】', function () {
  test('[1,2,3,4]第一個大於2的元素應為{位置:2,數值:3}', function () {
    const 測試向量 = new 向量([1, 2, 3, 4])
  ...
  test('[1,2,3,4]第一個大於2的元素（排除位置1）應為{位置:2,數值:3}', function () {
    const 測試向量 = new 向量([1, 2, 3, 4])
  ...
  test('[1,2,3,4]第一個大於6的元素應為{位置:-1,元素:null}', function () {
    const 測試向量 = new 向量([1, 2, 3, 4])
...
describe('測試【第一個小於】', function () {
  test('[1,2,3,4]第一個小於3的元素應為{位置:0,數值:1}', function () {
    const 測試向量 = new 向量([1, 2, 3, 4])
  ...
  test('[1,2,3,4]第一個小於4的元素（排除位置0）應為{位置:1,數值:2}', function () {
    const 測試向量 = new 向量([1, 2, 3, 4])
...
describe('測試【最大值】', function () {
  ...
  test('[]最大值應為{元素:null,位置:-1}', function () {
    const 測試向量 = new 向量()
    expect(測試向量.最大值()).toStrictEqual({
                                       位置: -1,
                                       元素: null,
  ...
  test('[1,2,3,4]最大值應為{元素:4,位置:3}', function () {
    const 測試向量 = new 向量([1, 2, 3, 4])
    expect(測試向量.最大值()).toStrictEqual({
                                       元素: 4,
                                       位置: 3,
  ...
  test('[1,2,3,4]排除4，應為{元素:3,位置:2}', function () {
    const 測試向量 = new 向量([1, 2, 3, 4])
  ...
  test('[1,2,3,4]排除null，應拋出型別錯誤例外', function () {
    const 測試向量 = new 向量([1, 2, 3, 4])
...
describe('測試【最小值】', function () {
  test('[4,3,2,1]最小值應為{元素:1,位置:3}', function () {
  ...
  test('[4,3,2,1]排除4，應為{元素:1,位置:3}', function () {
    const 測試向量 = new 向量([4, 3, 2, 1])
